...
public class SuperMarket 
{
	...
	public static void main(String[] args) 
	{
		...
		// NOTE: Testing removing item that was never in inventory
		//final String TESTFILE = "resources/inventory_no_such_item_in_inventory.txt";

		// NOTE: Testing the boundary condition when removing item from empty inventory.
